...
public class ExecutableWarMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		final Element element = MojoExecutor.element(MojoExecutor.name("outputDirectory"), "${project.build.directory}/foo");
		...
		MojoExecutor.executeMojo(
             ...
             MojoExecutor.configuration(new Element[]{element}),
